...
par(mfrow=c(2,2))
#First graphic
plot(proj1$dt_time_formatted,proj1$Global_active_power,type="l", ylab="Global Active Power", xlab="")
#Second
plot(proj1$dt_time_formatted, proj1$Voltage, type = "l", ylab = "Voltage", xlab = "datetime")
...
legend("topright",legend=c("Sub_metering_1","Sub_metering_2","Sub_metering_3"), bty="n", text.col=c("black","black","black"),lty=c(1,1,1), col=c("black","red","blue"))
plot(proj1$dt_time_formatted,proj1$Global_reactive_power,type="l", ylab="Global_reactive_power", xlab="datetime")
dev.off()
